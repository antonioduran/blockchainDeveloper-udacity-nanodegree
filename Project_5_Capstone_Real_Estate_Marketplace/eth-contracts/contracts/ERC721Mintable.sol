...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        // DONE TODO add functionality to transfer control of the contract to a newOwner.
...
// DONE TODO's: Create a Pausable contract that inherits from the Ownable contract
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        // DONE TODO return the token balance of given address
    ...
    function approve(address to, uint256 tokenId) public {
        //DONE TODO require the given address to not be the owner of the tokenId
        require(to != ownerOf(tokenId), "Cannot approve to the owner. The address is already token owner");

        //DONE TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender), "Only the owner or an operator can approve");

        //DONE TODO add 'to' address to token approvals
        _tokenApprovals[tokenId] = to;

        //DONE TODO emit Approval Event
        emit Approval(ownerOf(tokenId), to, tokenId);
    }

    function getApproved(uint256 tokenId) public view returns (address) {
        // DONE TODO return token approval if it exists
    ...
    function _mint(address to, uint256 tokenId) virtual internal {
        //DONE TODO revert if given tokenId already exists or given address is invalid
        require(!_exists(tokenId), "Token already exists");
        require(to != address(0), "Invalid address");
  
        //DONE TODO mint tokenId to given address & increase token count of owner
        _tokenOwner[tokenId] = to;
        _ownedTokensCount[to].increment();

        //DONE TODO emit Transfer event
    ...
    function _transferFrom(address from, address to, uint256 tokenId) virtual internal {
        //DONE TODO: require from address is the owner of the given token
        require(from == ownerOf(tokenId), "The address is not the owner of the token");

        //DONE TODO: require token is being transfered to valid address
        require(to != address(0), "Invalid address");
        
        //DONE TODO: clear approval
        _clearApproval(tokenId);

        //DONE TODO: update token counts & transfer ownership of the token ID 
        _ownedTokensCount[from].decrement();
        _ownedTokensCount[to].increment();
        _tokenOwner[tokenId] = to;

        //DONE TODO: emit correct event
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        //uint256 lastTokenIndex = _ownedTokens[from].length.sub(1); //This is not working with the latest version of solidity
       ...
       // _ownedTokens[from].length--; //This is not working with the latest version of solidity
    ...
    function _removeTokenFromAllTokensEnumeration(uint256 tokenId) private {
        ...
        //uint256 lastTokenIndex = _allTokens.length.sub(1); //This is not working with the latest version of solidity
        ...
        // This also deletes the contents at the last position of the array
        //_allTokens.length--; //This is not working with the latest version of solidity
        _allTokens.pop();
